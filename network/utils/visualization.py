...
def HeatMap(data,save_name, save_folder,color=[]):
    ...
    plt.imshow(data, cmap=cmap_custom, interpolation='nearest',vmin=0, vmax=255,)
    plt.axis('off')
    plt.savefig(save_folder+"/"+save_name, bbox_inches='tight', pad_inches=0)
    plt.close()
